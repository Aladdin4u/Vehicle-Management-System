...
const RegUsers = () => {
    return ( 
        <div className="bg-white rounded-lg shadow-md">
            <h1 className="block w-full bg-gray-100 px-3 py-2 shadow mb-2 font-bold">Registered Users</h1>
            <div className="px-3 py-2">
            <table className="border-collapse table-auto w-full">
                    <thead>
                        <tr>
                            <th className="py-3 bg-green-500 text-white">S/N</th>
                            <th className="py-3 bg-green-500 text-white">Name</th>
                            <th className="py-3 bg-green-500 text-white">Contact Number</th>
                            <th className="py-3 bg-green-500 text-white">Email</th>
                            <th className="py-3 bg-green-500 text-white">Registration Date</th>
